...
## General settings
parser.add_argument('--train_data_root', type=str, default='/home/ubuntu/pggan-structure/data/')
parser.add_argument('--train_pose_root', type=str, default='./pose/')
...
parser.add_argument('--nc', type=int, default=3)                # number of input channel # change nc
